    ...
    public class Serenity
    {
        ...
        public string returnMsg()
        {
            switch (CallOfSerenity + 1)
            {
                ...
                case 4:
                    gotoPCG GOTO6 = new gotoPCG(RandomNumberGenerator.NumberBetween(0, 3));
                    gotoPCG GOTO7 = new gotoPCG(RandomNumberGenerator.NumberBetween(0, 3));
                    return "Serenity 4: (Check on NPC(1)) \n" + GOTO6.returnMsg() + "Listen to NPC" + "\n" + GOTO7.returnMsg() + "Report to NPC \n" + "\n";

                case 5:
                    gotoPCG GOTO8 = new gotoPCG(RandomNumberGenerator.NumberBetween(0, 3));
                    gotoPCG GOTO9 = new gotoPCG(RandomNumberGenerator.NumberBetween(0, 3));
                ...
                case 6:
                    ...
                    gotoPCG GOTO10 = new gotoPCG(RandomNumberGenerator.NumberBetween(0, 3));
